...
Selected for 2026-07-08 from public, non-fork, non-archived repositories with recent activity. This is random and is not based on popularity.

| Repository | Stars | Language | Notes |
| --- | ---: | --- | --- |
| [dankogai/js-base64](https://github.com/dankogai/js-base64) | 4,367 | JavaScript | Base64 implementation for JavaScript |

Selection query: `stars:1001..5000 fork:false archived:false is:public pushed:>=2025-07-08 language:JavaScript`
